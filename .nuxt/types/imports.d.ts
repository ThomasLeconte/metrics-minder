...
declare global {
  ...
  const formatDisk: typeof import('../../utils/format-utils')['formatDisk']
  const formatDiskIO: typeof import('../../utils/format-utils')['formatDiskIO']
  const formatMemory: typeof import('../../utils/format-utils')['formatMemory']
  const formatNetworkIO: typeof import('../../utils/format-utils')['formatNetworkIO']
  const formatToGb: typeof import('../../utils/format-utils')['formatToGb']
  const formatToKb: typeof import('../../utils/format-utils')['formatToKb']
  const formatToMb: typeof import('../../utils/format-utils')['formatToMb']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly formatDisk: UnwrapRef<typeof import('../../utils/format-utils')['formatDisk']>
    readonly formatDiskIO: UnwrapRef<typeof import('../../utils/format-utils')['formatDiskIO']>
    readonly formatMemory: UnwrapRef<typeof import('../../utils/format-utils')['formatMemory']>
    readonly formatNetworkIO: UnwrapRef<typeof import('../../utils/format-utils')['formatNetworkIO']>
    readonly formatToGb: UnwrapRef<typeof import('../../utils/format-utils')['formatToGb']>
    readonly formatToKb: UnwrapRef<typeof import('../../utils/format-utils')['formatToKb']>
    readonly formatToMb: UnwrapRef<typeof import('../../utils/format-utils')['formatToMb']>
